...
import enrinal.com.popularmovies.adapters.ReviewAdapter;
import enrinal.com.popularmovies.adapters.TrailerAdapter;
import enrinal.com.popularmovies.data.MovieContract;
import enrinal.com.popularmovies.model.Movie;
import enrinal.com.popularmovies.model.Review;
import enrinal.com.popularmovies.model.Trailer;
...
public class DetailActivityFragment extends Fragment {
    ...
    @Bind(R.id.detail_title) TextView mTitleView;
    @Bind(R.id.detail_overview) TextView mOverviewView;
    @Bind(R.id.detail_date) TextView mDateView;
    @Bind(R.id.detail_vote_average) TextView mVoteAverageView;
    @Bind(R.id.detail_trailers) LinearListView mTrailersView;
    @Bind(R.id.detail_reviews) LinearListView mReviewsView;
    @Bind(R.id.detail_reviews_cardView) CardView mReviewsCardView;
    @Bind(R.id.detail_trailers_cardView) CardView mTrailersCardView;
        ...
        if (mMovie != null) {
            ...
            new AsyncTask<Void, Void, Integer>() {
                ...
                protected Integer doInBackground(Void... params) {
                    return Utility.isFavorite(mContext, mMovie.getId());
                }
